...
public class EditCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseRVModal = getIntent().getParcelableExtra("Info");
        ...
        databaseReference = firebaseDatabase.getReference("Info").child(courseID);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditCourseActivity.this, "Info Updated..", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(EditCourseActivity.this, "Failed to Update Info..", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
