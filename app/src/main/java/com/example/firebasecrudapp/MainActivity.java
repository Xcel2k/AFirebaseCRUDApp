...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    private void displayBottomSheet(CourseRVModal modal) {
        ...
        View layout = LayoutInflater.from(this).inflate(R.layout.bottom_sheet_layout, bottomSheet);
        ...
        courseNameTV.setText("Student's Name: " + modal.getCourseName());
        courseDescTV.setText("Hostel Required?" + modal.getCourseDescription());
        suitedForTV.setText("Father's Name:  " + modal.getBestSuitedFor());
        priceTV.setText("CMS ID: " + modal.getCoursePrice());
